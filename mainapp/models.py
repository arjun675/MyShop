...
class Seller(models.Model):
    ...
    addressline1 = models.CharField(max_length=100,blank=True,null=True,default=None)
    addressline2 = models.CharField(max_length=100,blank=True,null=True,default=None)
    addressline3 = models.CharField(max_length=100,blank=True,null=True,default=None)
...
class Checkout(models.Model):
    ...
    def __str__(self):
        return str(self.id)+" "+self.buyer.name+" "+str(self.active)
